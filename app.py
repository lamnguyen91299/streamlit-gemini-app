...
PROJECT_ID = os.environ.get("qwiklabs-gcp-00-758384dad3b9")  # Your Google Cloud Project ID
LOCATION = os.environ.get("us-central1")  # Your Google Cloud Project Region
vertexai.init(project='qwiklabs-gcp-00-758384dad3b9', location='us-central1')
